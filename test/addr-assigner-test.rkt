      ...
      (list
       (cons
         (fun-def
          ...
          (list
           (var-decl (decl 'a 0 'parm 'int))
           (var-decl (decl 'b 1 'parm 'int))
           (var-decl (decl 'c 2 'parm 'int))
           (var-decl (decl 'd 3 'parm '(pointer int)))
           (var-decl (let ([obj (decl 'e 4 'parm '(pointer int))])
                       (set-decl-offset! obj 4)
                       obj))
           (var-decl (let ([obj (decl 'f 5 'parm '(pointer int))])
